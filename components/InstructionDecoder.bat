...
set /a i3=io1+io2
if %i3% == 2 (set "INPUT=1") else (set "INPUT=0")
...
set /a i6=io3+io4
if %i6% == 2 (set "OUTPUT=1") else (set "OUTPUT=0")
...
set /a i9=io5+io6
if %i9% == 2 (set "LOAD=1") else (set "LOAD=0")
...
set /a j3=io7+io8
if %j3% == 2 (set "ADD=1") else (set "ADD=0")
...
set /a j6=io9+ioa1
if %j6% == 2 (set "JUMP=1") else (set "JUMP=0")
...
set /a j9=ioa2+ioa3
if %j9% == 2 (set "JUMPcon=1") else (set "JUMPcon=0")
...
set /a ja3=ioa4+ioa5
if %ja3% == 2 (set "SUB=1") else (set "SUB=0")
